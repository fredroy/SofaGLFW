...
bool SofaGLFWBaseGUI::init(int nbMSAASamples)
{
    ...
    {
        // Request OpenGL 4.1 compatibility profile
        glfwWindowHint(GLFW_CONTEXT_VERSION_MAJOR, 4);
        glfwWindowHint(GLFW_CONTEXT_VERSION_MINOR, 1);
#ifdef __APPLE__
        // macOS requires forward-compatible core profile for GL 4.1
...
void SofaGLFWBaseGUI::makeCurrentContext(GLFWwindow* glfwWindow)
{
    ...
    if (!m_bGlewIsInitialized)
    {
        ...
        glewInit();
        // Clear any GL error generated by glewInit() in core profile
...
#ifndef __APPLE__
    // Fixed-function pipeline setup (not available in core profile)
